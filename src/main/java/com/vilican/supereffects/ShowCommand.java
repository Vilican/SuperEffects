    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length > 0) {
            ...
            if (args[0].equalsIgnoreCase("help")) {
                ...
                return true;
            } else if (sender.hasPermission("sef.others.show")) {
                Player player = Bukkit.getPlayer(args[0]);
                if (player != null) {
                    com.vilican.supereffects.Functions.show(player);
            ...
            if (sender.hasPermission("sef.self.show")) {
                Player playersender = (Player) sender;
                com.vilican.supereffects.Functions.show(playersender);
                sender.sendMessage(ChatColor.GREEN + "Effect removed");
                return true;
            } else {
                sender.sendMessage(ChatColor.RED + "Access denied!");
